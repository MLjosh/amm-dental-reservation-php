			...
			<form method="POST">
				...
				<div class="modal-footer text-center">
					<div class="col-md-12">
						...
						$ss=$row['Status'];
						if ($ss==1 or $ss=='') { ?>
						<button type="button" class="btn btn-fill btn-warning" data-dismiss="modal" data-backdrop="static" data-keyboard="false" data-target="#cancel_modal<?php echo $row["ID"]?>" data-toggle="modal">Cancel Appointment</button>
						<?php } ?>
