<div class="modal" tabindex="-1" id="update_modal3<?php echo $row['ID']?>" aria-hidden="true" data-backdrop="static" data-keyboard="false">
          				...
          				<div class="row">
				          	...
				          	<div class="col-12 col-sm-6 text-left">
								<select name="work" class="form-control" >
								  <option value="" selected="true">PENDING</option>
