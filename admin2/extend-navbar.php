            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <?php if($num>0){
                  ...
                  <li class="nav-link"><a href="view-notification.php" class="nav-item dropdown-item">New appointment received from <?php echo $result['Name'];?></a></li>
              ...
              <li class="nav-link"><a href="#" class="nav-item dropdown-item">No New Appointment Received</a></li>
                 <?php } ?>
                  ...
                  <li class="nav-link"><a href="view-notification.php" class="nav-item dropdown-item"><b>See All Notification</b></a></li>
                </ul>
              </li>
 <?php
$adid=$_SESSION['ODABSaid1'];
$ret=mysqli_query($con,"select AdminName from tbladmin where ID='$adid'");
$ret2=mysqli_query($con,"select UserName from tbladmin where ID='$adid'");
...
?> 
              ...
              <li style="margin-top: 12px;
                margin-right: -10px;
                padding-right: 0;">
                Welcome! Admin, <b><?php echo $name; ?></b>
              </li>
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="dropdown-divider"></li>
                  <li class="nav-link"><a href="logout.php?viewid=<?php echo $row2['UserName']; ?>" class="nav-item dropdown-item">Log out</a></li>
                </ul>
              </li>
